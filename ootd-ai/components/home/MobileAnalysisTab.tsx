...
import type { FashionCritique, ItemAnnotation } from '../../hooks/useOotdAnalysis';
...
// Zone → y% (position within the photo container)
const ZONE_Y: Record<string, number> = { head: 8, upper: 25, mid: 42, lower: 60, feet: 80 };

function AnnotationOverlay({ annotations }: { annotations: ItemAnnotation[] }) {
