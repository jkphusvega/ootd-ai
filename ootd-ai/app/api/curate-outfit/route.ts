...
export async function POST(request: Request) {
  try {
    ...
    let profileContext = '';
    if (userProfile) {
      profileContext = `User's body: ${userProfile.height}cm, ${userProfile.weight}kg, prefers ${userProfile.fit_preference} fit. Body shape: ${userProfile.body_shape || 'Not specified'}. Styling goal: ${userProfile.body_goal || 'Not specified'}. Style moods: ${userProfile.style_moods?.join(', ') || 'not specified'}.`;
    }
